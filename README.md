# GeoTreasureHunt
GeoTreasureHunt is a fun and rewarding treasure hunting game that also encourages a healthy lifestyle.

With lesser people travelling out due to the Covid-19 pandemic, people are staying and working from home, resulting in unfit and unhealthy lifestyles. Hence, GeoTreasureHunt aims to improve lifestyles by encouraging people to go outdoors more.

It utilises Kong as the API gateway to manage API requests between microservices. 
...
##  Testing (using different types of end-users)
